...
export const metadata: Metadata = {
  title: 'Importen',
  description: 'Beregn importkostnad for bil til Norge',
}
  ...
  return (
    <html lang="nb" className={`${fraunces.variable} ${inter.variable}`}>
      <body className="bg-slate-50 text-navy-900 antialiased">
        {children}
        <Toaster position="top-right" toastOptions={{ style: { borderRadius: '10px', background: '#0a1628', color: '#fff', fontSize: '14px' } }} />
      </body>
    </html>
  )
}
